...
BLOG_AUTHOR = "Lincoln de Macêdo"  # (translatable)
BLOG_TITLE = "Anotações sobre NLP"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://demacdolincoln.github.io/anotacoes-nlp/posts/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://demacdolincoln.github.io/anotacoes-nlp/posts/"
BLOG_EMAIL = "demacdolincoln@gmail.com"
BLOG_DESCRIPTION = "Uma pequena ajuda mais prática que técnica ou teórica para quem está aprendendo sobre NLP"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "demacdolincoln"
...
<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.5/languages/python.min.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.5/languages/julia.min.js"></script>
